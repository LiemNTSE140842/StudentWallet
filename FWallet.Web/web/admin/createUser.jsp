...
<body class=" sidebar-mini ">
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      <!-- Navbar -->
      <!-- End Navbar -->
            <form id="TypeValidation" class="form-horizontal" action="<%= request.getContextPath() %>/CreateController" method="POST">
              <div class="card ">
                ...
                <div class="card-body ">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group">
                        <input class="form-control" type="text" name="gender" required="true" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
