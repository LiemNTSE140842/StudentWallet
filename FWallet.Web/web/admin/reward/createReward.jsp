    ...
    <body class=" sidebar-mini ">
        ...
        <div class="wrapper ">
            ...
            <div class="main-panel" id="main-panel">
                <!-- Navbar -->
                <!-- End Navbar -->
                <form id="TypeValidation" class="form-horizontal" action="<%= request.getContextPath()%>/CreateRewardDataController" method="POST">
                    <div class="card ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        ...
                                        %>
                                        <select name="channelID" class="form-control" id="exampleFormControlSelect1" required="true">
                                            <%                                                if (channelList != null) {
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <%
                                            ...
                                            List<RewardTypeDTO> rewardtypeList = rewardtypedao.getAllRewardID();

                                        %>
                                        <select name="rewardType" class="form-control" id="exampleFormControlSelect1" required="true">
