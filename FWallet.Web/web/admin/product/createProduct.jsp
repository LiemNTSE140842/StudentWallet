...
<body class=" sidebar-mini ">
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
      <!-- Navbar -->
      <!-- End Navbar -->
            <form id="TypeValidation" class="form-horizontal" action="<%= request.getContextPath() %>/CreateProductController" method="POST">
              <div class="card ">
                ...
                <div class="card-body ">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group">
                        <input class="form-control" type="text" name="categoryID" required="true" />
                      </div>
                    </div>
                    </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group">
                        <input class="form-control" type="number" value= "1" min="0" name="price" required="true" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group">
                        <input class="form-control" type="number" value= "1" min="0" name="quantity" required="true" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
