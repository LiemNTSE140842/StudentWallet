                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">      
                                    <form action="ShowTransactionbyCate" method="POST">

                                        <select name="transaction">
                                            <c:forEach items="${sessionScope.LISTCATE}" var="h">
                                                <option value="${h}" <c:if test="${h eq requestScope.ISSELECTED}">selected</c:if> >${h}</option> 
                                            </c:forEach>
                                                                                 
                                        </select>
                                        <input type="submit" value="Search" name="search" />
                                        <div class="table-responsive">
                                            <c:if test="${empty requestScope.ISSELECTED}">
                                                <table class="table">
                                            ...
                                            <c:if test="${not empty requestScope.ISSELECTED}">
                                                <table class="table">
                                                    <thead class="text-primary">
                                                    <th class="text-center">
                                                        STT
                                                    </th>
                                                    <c:if test="${empty requestScope.MINUS}">
                                                        <th>
                                                            Student Reward
                                                        </th>
                                                    </c:if>
                                                    ...
                                                    <c:if test="${empty requestScope.PLUS}">
                                                    <th class="text-center">
                                                        Order ID
                                                    </th>
                                                    ...
                                                    <tbody>                    
                                                        <c:forEach items="${sessionScope.LIST_TRANSACTION}" varStatus="counter" var="h"> 
                                                            <c:if test="${not empty requestScope.MINUS}">
                                                                <tr class="table-danger">
