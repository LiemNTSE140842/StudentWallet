 ...
 * @author pphuh
 */
@WebServlet(name = "SearchRewardDataController", urlPatterns = {"/SearchRewardDataController"})
public class SearchRewardDataController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at SearchRewardDataController: " + e.toString());
        }finally{
